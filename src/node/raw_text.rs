...
/// for TokenStream.
/// # Config
/// Parsing behaviour is affected by
/// [raw_text_elements](crate::ParserConfig::raw_text_elements).
/// ## Example
/// The difference of parsing of two tags, where `title` tag is not included
/// into [raw_text_elements](crate::ParserConfig::raw_text_elements),
/// and `script` tag - on the contrary,
/// is best illustrated by the following example, using `html!` macro from [html-to-string-macro](https://github.com/rs-tml/rstml/tree/main/examples/html-to-string-macro).
///
///    ```ignore
///    let world = "planet";
///    ...
...
///    ```
///
/// In the case of `title`, the content between opening `title` and closing
/// `title` is parsed as a vector of [Nodes](crate::node::Node):
/// [RawText](crate::node::RawText), [NodeText](crate::node::NodeText),
/// [NodeElement](crate::node::NodeElement) , [RawText](crate::node::RawText),
/// [NodeBlock](crate::node::NodeBlock).
///
